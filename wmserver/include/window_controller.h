...
public:
    ...
    void NotifyDisplayStateChange(DisplayId displayId, ScreenId groupid, sptr<DisplayInfo> info, DisplayStateChangeType type);
...
private:
    ...
    void ProcessDisplayChange(DisplayId displayId, ScreenId groupid, sptr<DisplayInfo> info, DisplayStateChangeType type);
