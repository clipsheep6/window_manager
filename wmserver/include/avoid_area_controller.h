...
using AvoidNodesMapPtr = std::unique_ptr<std::map<uint32_t, sptr<WindowNode>>>;
...
private:
    AvoidNodesMapPtr GetAvoidNodesByDisplayId(DisplayId displayId);
    ...
    std::map<DisplayId, AvoidNodesMapPtr> avoidNodesMaps_;
