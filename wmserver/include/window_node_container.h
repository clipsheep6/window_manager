...
public:
    ...
    std::map<DisplayId, Rect> GetAllDisplays() const;
    ...
    sptr<MultiDisplayController> GetMutiDisplayController() const;
...
private:
    ...
    sptr<MultiDisplayController> multiDisplayController_;
