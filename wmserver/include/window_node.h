...
public:
    ...
    void SetShownDisplay(const std::vector<DisplayId>& displayIdVec);
    ...
    std::vector<DisplayId> GetShownDisplay();
    ...
    bool isCrossDisplay_ { false };
    std::vector<DisplayId> shownDisplay_;
