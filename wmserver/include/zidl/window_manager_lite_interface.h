...
public:
    ...
    // do not need enum
    virtual WMError MinimizeAllAppWindows(DisplayId displayId) { return WMError::WM_OK; };
    virtual WMError ToggleShownStateForAllAppWindows() {return WMError::WM_OK; };
    virtual WMError SetWindowLayoutMode(WindowLayoutMode mode) {return WMError::WM_OK; };
