...
public:
    ...
    enum class WindowManagerMessage : uint32_t {
        ...
        TRANS_ID_GET_UNTOUCHABLE_UNRELIABLE_WINDOW_INFO_ID,
    };
    ...
    virtual WMError GetUntouchableUnreliableWindowInfo(int32_t windowId,
        std::vector<sptr<UntouchableUnreliableWindowInfo>>& infos) = 0;
