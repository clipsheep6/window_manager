...
public:
    ...
    Rect GetFullDisplayRect(DisplayId displayId) const;
...
private:
    ...
    std::map<DisplayId, sptr<DisplayInfo>> GetDisplayRectsForAllDisplay(const std::vector<DisplayId>& displayIdVec);
