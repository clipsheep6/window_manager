...
public:
    ...
    void ProcessDisplaySizeChange(DisplayId displayId, const Rect& displayRect);
...
protected:
    ...
    void UpdateFullDisplayRect();
    void UpdateFullLimitRect();
    void UpdateMutiDisplayFlag();
    void AfterProcessDisplayChange();
    ...
    Rect fullDisplayRect_;
    Rect fullLimitRect_;
    bool isMutiDisplay_ = false;
};
}
}
