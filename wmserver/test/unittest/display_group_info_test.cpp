...
void DisplayGroupInfoTest::AddTestDisplayInfo(std::map<DisplayId, sptr<DisplayInfo>>& displayInfosMap_)
{
    ...
    displayInfo1->SetOffsetX(0);
    displayInfo1->SetOffsetY(0);
    displayInfo1->SetHeight(0);
    displayInfo1->SetWidth(0);
    ...
    displayInfo2->SetOffsetX(2);
    displayInfo2->SetOffsetY(2);
    displayInfo2->SetHeight(2);
    displayInfo2->SetWidth(2);
