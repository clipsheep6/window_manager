...
HWTEST_F(WindowControllerTest, RaiseToAppTop, Function | SmallTest | Level3)
{
    ...
    ASSERT_EQ(WmErrorCode::WM_ERROR_STATE_ABNORMALLY,
        WM_JS_TO_ERROR_CODE_MAP.at(windowController_->RaiseToAppTop(windowId)));

    windowRoot_->windowNodeMap_.insert(std::make_pair(windowNode->GetWindowId(), windowNode));
    ASSERT_EQ(WmErrorCode::WM_ERROR_INVALID_PARENT,
        WM_JS_TO_ERROR_CODE_MAP.at(windowController_->RaiseToAppTop(windowId)));
    ...
    ASSERT_EQ(WmErrorCode::WM_ERROR_STAGE_ABNORMALLY,
        WM_JS_TO_ERROR_CODE_MAP.at(windowController_->RaiseToAppTop(windowId)));
