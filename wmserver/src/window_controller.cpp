...
void WindowController::NotifyDisplayStateChange(DisplayId displayId, ScreenId groupid, sptr<DisplayInfo> info, DisplayStateChangeType type)
{
...
void WindowController::ProcessDisplayChange(DisplayId displayId, ScreenId groupid, sptr<DisplayInfo> info, DisplayStateChangeType type)
{
    if (info == nullptr) {
