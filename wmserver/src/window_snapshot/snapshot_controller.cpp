...
{
    std::shared_ptr<SurfaceCaptureCallback> cb = std::make_shared<GetSurfaceCapture>();
    GetSurfaceCapture *callback = (GetSurfaceCapture*)cb.get();
    rsInterface_.TakeSurfaceCapture(surfaceNode, cb);
