...
const std::map<std::string, WindowManagerConfig::ValueType> WindowManagerConfig::configItemTypeMap_ = {
    ...
    { "maxFloatingWidth",       WindowManagerConfig::ValueType::INTS },
    { "maxFloatingHeight",      WindowManagerConfig::ValueType::INTS },
    { "minFloatingWidth",       WindowManagerConfig::ValueType::INTS },
    { "minFloatingHeight",      WindowManagerConfig::ValueType::INTS },
