...
public:
     ...
     * of the want parameter and the startOptions parameter and then starts it. You can specify the ability to start using the want parameter.
     *
     * @param want Indicates the Want containing information about the target ability to start.
     * @param startOptions Indicates the startOptions containing information about the WindowMode and the displayId to start.
     *
