...
#define TLOGD(tag, fmt, ...) PRINT_TLOG(LOG_DEBUG, tag, FMT_PREFIX fmt, FILE_NAME, _W_FUNC, __LINE__, ##__VA_ARGS__)
#define TLOGI(tag, fmt, ...) PRINT_TLOG(LOG_INFO, tag, FMT_PREFIX fmt, FILE_NAME, _W_FUNC, __LINE__, ##__VA_ARGS__)
#define TLOGW(tag, fmt, ...) PRINT_TLOG(LOG_WARN, tag, FMT_PREFIX fmt, FILE_NAME, _W_FUNC, __LINE__, ##__VA_ARGS__)
#define TLOGE(tag, fmt, ...) PRINT_TLOG(LOG_ERROR, tag, FMT_PREFIX fmt, FILE_NAME, _W_FUNC, __LINE__, ##__VA_ARGS__)
