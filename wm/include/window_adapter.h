...
public:
    ...
    virtual WMError AddExtensionDeathRecipient(int32_t parentId, int32_t persistentId,
        sptr<ISessionStage>& sessionStage);
    virtual WMError AddExtensionSessionInfo(int32_t parentId, int32_t persistentId);
