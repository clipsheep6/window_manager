    ...
    sptr<PictureInPictureController> pipController)
{
    ...
    if (mainWindow != nullptr) {
        mainWindowLifeCycleImpl_ = new PictureInPictureController::PipMainWindowLifeCycleImpl(pipController->GetPiPNavigationId());
...
void PictureInPictureManager::AutoStartPipWindow(std::string navigationId)
{
    ...
    if (mainWindow) {
        ...
        if (navController->IsNavDestinationInTopStack()) {
            ...
            if (autoStartControllerMap_.empty() || autoStartControllerMap_.find(handleId) == autoStartControllerMap_.end()) {
