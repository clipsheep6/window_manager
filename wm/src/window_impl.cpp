...
void WindowImpl::ReadyToMoveOrDragWindow(int32_t globalX, int32_t globalY, int32_t pointId, const Rect& rect)
{
    ...
    startRectExceptFrame_.posX_ = startPointRect_.posX_ + static_cast<int32_t>(WINDOW_FRAME_WIDTH);
    startRectExceptFrame_.posY_ = startPointRect_.posY_ + static_cast<int32_t>(WINDOW_FRAME_TOP_WIDTH);
    startRectExceptFrame_.width_ = startPointRect_.width_ - (WINDOW_FRAME_WIDTH + WINDOW_FRAME_WIDTH);
    startRectExceptFrame_.height_ = startPointRect_.height_ - (WINDOW_FRAME_TOP_WIDTH + WINDOW_FRAME_WIDTH);
