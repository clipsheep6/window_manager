    ...
    int32_t baseParent, std::list<Accessibility::AccessibilityElementInfo>& infos)
{
    ...
    infos = uiContent_->SearchElementInfoByAccessibilityId(elementId, mode, baseParent);
    WLOGFD("NotifySearchElementInfoByAccessibilityId OK, elementId:%{public}d, mode:%{public}d, size:%{public}d",
    ...
    int32_t baseParent, Accessibility::AccessibilityElementInfo& info)
{
    ...
    info = uiContent_->FindFocusedElementInfo(elementId, focusType, baseParent);
    WLOGFD("NotifyFindFocusedElementInfo OK, elementId:%{public}d, focusType:%{public}d", elementId, focusType);
    return WSError::WS_OK;
}
    ...
    Accessibility::AccessibilityElementInfo& info)
{
    ...
    info = uiContent_->FocusMoveSearch(elementId, direction, baseParent);
    WLOGFD("NotifyFocusMoveSearch ok, elementId:%{public}d, direction:%{public}d", elementId, direction);
    return WSError::WS_OK;
}
} // namespace Rosen
} // namespace OHOS
