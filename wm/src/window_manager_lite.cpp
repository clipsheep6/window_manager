...
public:
    ...
    sptr<WindowManagerAgentLite> systemBarChangedListenerAgent_;
    ...
    sptr<WindowManagerAgentLite> cameraFloatWindowChangedListenerAgent_;
    std::vector<sptr<IWaterMarkFlagChangedListener>> waterMarkFlagChangeListeners_;
    sptr<WindowManagerAgentLite> waterMarkFlagChangeAgent_;
    std::vector<sptr<IGestureNavigationEnabledChangedListener>> gestureNavigationEnabledListeners_;
    sptr<WindowManagerAgentLite> gestureNavigationEnabledAgent_;
};
...
void WindowManagerLite::Impl::NotifySystemBarChanged(DisplayId displayId, const SystemBarRegionTints& tints)
{
    for (auto tint : tints) {
...
void WindowManagerLite::Impl::UpdateCameraFloatWindowStatus(uint32_t accessTokenId, bool isShowing)
{
...
void WindowManagerLite::Impl::NotifyWaterMarkFlagChangedResult(bool showWaterMark)
{
...
void WindowManagerLite::Impl::NotifyGestureNavigationEnabledResult(bool enable)
{
...
WMError WindowManagerLite::RegisterSystemBarChangedListener(const sptr<ISystemBarChangedListener>& listener)
{
    if (listener == nullptr) {
        WLOGFE("listener could not be null");
        return WMError::WM_ERROR_NULLPTR;
    ...
    if (pImpl_->systemBarChangedListenerAgent_ == nullptr) {
        pImpl_->systemBarChangedListenerAgent_ = new WindowManagerAgentLite();
        ret = SingletonContainer::Get<WindowAdapterLite>().RegisterWindowManagerAgent(
...
WMError WindowManagerLite::UnregisterSystemBarChangedListener(const sptr<ISystemBarChangedListener>& listener)
{
    if (listener == nullptr) {
        WLOGFE("listener could not be null");
        return WMError::WM_ERROR_NULLPTR;
...
WMError WindowManagerLite::MinimizeAllAppWindows(DisplayId displayId)
{
    WLOGFD("displayId %{public}" PRIu64"", displayId);
    return SingletonContainer::Get<WindowAdapterLite>().MinimizeAllAppWindows(displayId);
}

WMError WindowManagerLite::ToggleShownStateForAllAppWindows()
{
    WLOGFD("ToggleShownStateForAllAppWindows");
    return SingletonContainer::Get<WindowAdapterLite>().ToggleShownStateForAllAppWindows();
}

WMError WindowManagerLite::SetWindowLayoutMode(WindowLayoutMode mode)
{
    WLOGFD("set window layout mode: %{public}u", mode);
    WMError ret  = SingletonContainer::Get<WindowAdapterLite>().SetWindowLayoutMode(mode);
    if (ret != WMError::WM_OK) {
...
WMError WindowManagerLite::RegisterCameraFloatWindowChangedListener(const sptr<ICameraFloatWindowChangedListener>& listener)
{
    if (listener == nullptr) {
        WLOGFE("listener could not be null");
        return WMError::WM_ERROR_NULLPTR;
    ...
    if (pImpl_->cameraFloatWindowChangedListenerAgent_ == nullptr) {
        pImpl_->cameraFloatWindowChangedListenerAgent_ = new WindowManagerAgentLite();
        ret = SingletonContainer::Get<WindowAdapterLite>().RegisterWindowManagerAgent(
...
WMError WindowManagerLite::UnregisterCameraFloatWindowChangedListener(
...
WMError WindowManagerLite::RegisterWaterMarkFlagChangedListener(const sptr<IWaterMarkFlagChangedListener>& listener)
{
    if (listener == nullptr) {
        WLOGFE("listener could not be null");
        return WMError::WM_ERROR_NULLPTR;
    ...
    if (pImpl_->waterMarkFlagChangeAgent_ == nullptr) {
        pImpl_->waterMarkFlagChangeAgent_ = new WindowManagerAgentLite();
        ret = SingletonContainer::Get<WindowAdapterLite>().RegisterWindowManagerAgent(
...
WMError WindowManagerLite::UnregisterWaterMarkFlagChangedListener(const sptr<IWaterMarkFlagChangedListener>& listener)
{
    if (listener == nullptr) {
        WLOGFE("listener could not be null");
        return WMError::WM_ERROR_NULLPTR;
...
WMError WindowManagerLite::RegisterGestureNavigationEnabledChangedListener(
    const sptr<IGestureNavigationEnabledChangedListener>& listener)
{
    ...
    if (pImpl_->gestureNavigationEnabledAgent_ == nullptr) {
        pImpl_->gestureNavigationEnabledAgent_ = new (std::nothrow)WindowManagerAgentLite();
        if (pImpl_->gestureNavigationEnabledAgent_ != nullptr) {
            ret = SingletonContainer::Get<WindowAdapterLite>().RegisterWindowManagerAgent(
...
WMError WindowManagerLite::UnregisterGestureNavigationEnabledChangedListener(
    const sptr<IGestureNavigationEnabledChangedListener>& listener)
{
    if (listener == nullptr) {
        WLOGFE("listener could not be null");
...
{
    WLOGFE("[Test]Get Focus window info lite");
...
void WindowManagerLite::UpdateSystemBarRegionTints(DisplayId displayId,
...
WMError WindowManagerLite::DumpSessionAll(std::vector<std::string> &infos)
{
    WMError ret = SingletonContainer::Get<WindowAdapterLite>().DumpSessionAll(infos);
    if (ret != WMError::WM_OK) {
...
WMError WindowManagerLite::DumpSessionWithId(int32_t persistentId, std::vector<std::string> &infos)
{
    WMError ret = SingletonContainer::Get<WindowAdapterLite>().DumpSessionWithId(persistentId, infos);
    if (ret != WMError::WM_OK) {
...
WMError WindowManagerLite::SetGestureNavigaionEnabled(bool enable) const
{
    WMError ret = SingletonContainer::Get<WindowAdapterLite>().SetGestureNavigaionEnabled(enable);
    if (ret != WMError::WM_OK) {
...
WMError WindowManagerLite::NotifyWindowExtensionVisibilityChange(int32_t pid, int32_t uid, bool visible)
{
    WMError ret = SingletonContainer::Get<WindowAdapterLite>().NotifyWindowExtensionVisibilityChange(pid, uid, visible);
    if (ret != WMError::WM_OK) {
...
void WindowManagerLite::UpdateCameraFloatWindowStatus(uint32_t accessTokenId, bool isShowing) const
{
    pImpl_->UpdateCameraFloatWindowStatus(accessTokenId, isShowing);
}

void WindowManagerLite::NotifyWaterMarkFlagChangedResult(bool showWaterMark) const
{
    pImpl_->NotifyWaterMarkFlagChangedResult(showWaterMark);
}

void WindowManagerLite::NotifyGestureNavigationEnabledResult(bool enable) const
{
