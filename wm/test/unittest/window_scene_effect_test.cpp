...
{
	const sptr<WindowSessionImpl>& window = Utils::CreateTestWindow(windowInfo_);
	ASSERT_NE(nullptr, window);
...
{
	const sptr<WindowSessionImpl>& window = Utils::CreateTestWindow("blurRadius");
	ASSERT_NE(nullptr, window);
...
{
	const sptr<WindowSessionImpl>& window = Utils::CreateTestWindow("backdropBlurRadius");
	ASSERT_NE(nullptr, window);
...
{
	const sptr<WindowSessionImpl>& window = Utils::CreateTestWindow("backdropBlurStyle");
	ASSERT_NE(nullptr, window);
