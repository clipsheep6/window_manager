...
public:
    ...
    enum {
        ...
        TRANS_ID_SCREEN_CREAT_MIRROR = TRANS_ID_SCREENGROUP_BASE,
        TRANS_ID_SCREEN_ADD_MIRROR,
    };
    ...
    virtual DMError CreateMirror(ScreenId mainScreenId, std::vector<ScreenId> mirrorScreenId) = 0;
};
} // namespace OHOS::Rosen
