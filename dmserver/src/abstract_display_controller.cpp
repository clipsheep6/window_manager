...
void AbstractDisplayController::ProcessDisplayRotationChange(sptr<AbstractScreen> absScreen, DisplayStateChangeType type)
{
...
void AbstractDisplayController::ProcessDisplayUpdateOrientation(sptr<AbstractScreen> absScreen, DisplayStateChangeType type)
{
    sptr<AbstractDisplay> abstractDisplay = nullptr;
    {
        std::lock_guard<std::recursive_mutex> lock(mutex_);
