    ...
    MessageOption &option)
{
    ...
    switch (code) {
        ...
        case TRANS_ID_SCREEN_CREAT_MIRROR: {
            ...
            WLOGI("create mirror in stub. screen:%{public}" PRIu64"", mirrorScreenId[0]);
            DMError result = CreateMirror(mainScreenId, mirrorScreenId);
            reply.WriteInt32(static_cast<int32_t>(result));
            break;
        }
        default:
