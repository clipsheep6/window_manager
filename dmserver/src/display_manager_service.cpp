...
{
    auto isSys = Permission::IsSystemCalling();
    auto isStartByHdcd = Permission::IsStartByHdcd();
    WLOGFI("arong isSys: %{public}d, isStartByHdcd: %{public}d",isSys,isStartByHdcd);
    if (!isSys && !isStartByHdcd) {
