...
namespace OHOS {
namespace Rosen {
// constexpr uint32_t DELAY_TIME_US = 1000000;
class WaterMarkFlagChangedListenerFuture : public IWaterMarkFlagChangedListener {
public:
    void OnWaterMarkFlagUpdate(const bool showWaterMark) override
    {
...
int main(int argc, char *argv[])
{
    ...
    auto listener = new WaterMarkFlagChangedListenerFuture();
