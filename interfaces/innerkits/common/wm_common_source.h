...
#ifndef OHOS_ROSEN_WM_COMMON_SOURCE_H
#define OHOS_ROSEN_WM_COMMON_SOURCE_H
...
typedef OHOS::Ace::WindowSizeChangeReason WindowSizeChangeReason;
...
#endif // OHOS_ROSEN_WM_COMMON_SOURCE_H
