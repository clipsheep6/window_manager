...
#ifndef FOUNDATION_DM_SCREEN_GROUP_LITE_H
#define FOUNDATION_DM_SCREEN_GROUP_LITE_H
...
class ScreenGroupLite : public ScreenLite {
friend class ScreenManagerLite;
public:
    ~ScreenGroupLite();
    ScreenGroupLite(const ScreenGroupLite&) = delete;
    ScreenGroupLite(ScreenGroupLite&&) = delete;
    ScreenGroupLite& operator=(const ScreenGroupLite&) = delete;
    ScreenGroupLite& operator=(ScreenGroupLite&&) = delete;
...
private:
    ...
    explicit ScreenGroupLite(sptr<ScreenGroupInfo> info);
