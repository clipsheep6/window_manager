...
public:
    virtual void OnSystemBarPropertyChange(uint32_t displayId, const SystemBarProps& props) = 0;
};
...
private:
    ...
    void UpdateSystemBarProperties(uint32_t displayId, const SystemBarProps& props) const;
