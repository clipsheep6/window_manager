...
#ifndef NATIVE_WINDOW_COMM_H
#define NATIVE_WINDOW_COMM_H
...
typedef enum {
    OH_KEY_ACTION_UNKNOW = -1,
    OH_KEY_ACTION_DOWN = 0,
    OH_KEY_ACTION_UP = 1,
} OH_WMKeyAction;
...
typedef struct {
    OH_WMKeyAction action;
    OH_WMKeyCode code;
    uint32_t pressedKeySize;
    OH_WMKeyCode* pressedKeys;
    int64_t timestamp;
} OH_WMKeyEvent;
