...
bool JsExtensionWindowRegisterManager::IsCallbackRegistered(napi_evn env, std::string type, napi_value jsListenerObject)
{
                                                               ...
                                                               CaseType caseType, napi_env env, napi_value value)
{
    ...
    std::shared_ptr<NativeReferecne> callbackRef(reinterpret_cast<NativeReference*>(result));
