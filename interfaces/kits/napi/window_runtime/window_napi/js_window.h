...
public:
    ...
    static napi_value IsImmersiveFullScreenExisted(napi_env env, napi_callback_info info);
...
private:
    ...
    napi_value OnIsImmersiveFullScreenExisted(napi_env env, napi_callback_info info);
