...
public:
    ...
    static NativeValue* SetStatusBarEnabled(NativeEngine* engine, NativeCallbackInfo* info);
...
private:
    ...
    static NativeValue* OnSetStatusBarEnabled(NativeEngine& engine, NativeCallbackInfo& info);
