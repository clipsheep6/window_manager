...
struct PreviewerWindowModel {
    ...
    Ace::DeviceOrientation orientation = Ace::DeviceOrientation::PORTRAIT; // orientation
    double density = 1.0; // dpi with calculate
    Ace::DeviceType deviceType = Ace::DeviceType::PHONE; // device type
    Ace::ColorMode colorMode = Ace::ColorMode::LIGHT; // color mode
};
