...
private:
    ...
    void CacheStartingWindowInfo(const AppExecFwk::AbilityInfo& abilityInfo, const std::string& path,
    ...
    int GetRemoteSessionInfos(const std::string& deviceId, int32_t numMax, std::vector<SessionInfoBean> &sessionInfos);
    ...
    std::map<int32_t, sptr<SceneSession>> sceneSessionMap_, systemTopSceneSessionMap_, nonSystemFloatSceneSessionMap_;
