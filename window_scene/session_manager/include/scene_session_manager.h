...
public:
    ...
    void ReportScreenFoldStatusChange(const std::vector<std::string>& screenFoldInfo);
...
private:
    ...
    WMError SetScreenFoldEvent(const std::vector<std::string>& screenFoldInfo, ScreenFoldData& screenFoldData);
