    ...
    bool needRemoveSession, bool isSaveSnapshot, bool isForceClean)
{
    auto task = [this, weakSceneSession = wptr<SceneSession>(sceneSession),
        ...
        TLOGI(WmsLogTag::WMS_MAIN, "Destruct session id:%{public}d remove:%{public}d", persistentId, needRemoveSession,
            " isSaveSnapshot:%{public}d isForceClean:%{public}d", isSaveSnapshot, isForceClean);
