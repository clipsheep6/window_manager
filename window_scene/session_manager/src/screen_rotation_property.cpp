...
void ScreenRotationProperty::SetScreenRotation(Rotation targetRotation, bool withAnimation)
{
    ...
    ScreenSessionManager::GetInstance().SetRotationFromWindow(defaultDisplayId_, targetRotation, withAnimation);
...
void ScreenRotationProperty::ProcessSwitchToSensorUnrelatedOrientation(Orientation orientation, bool withAnimation)
{
...
void ScreenRotationProperty::ProcessOrientationSwitch(Orientation orientation, bool withAnimation)
{
    if (!IsSensorRelatedOrientation(orientation)) {
