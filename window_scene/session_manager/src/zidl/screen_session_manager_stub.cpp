...
void ScreenSessionManagerStub::InitGroup1() 
{
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_WAKE_UP_BEGIN,
        &ScreenSessionManagerStub::WakeUpBeginFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_WAKE_UP_END,
        &ScreenSessionManagerStub::WakeUpEndFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SUSPEND_BEGIN,
        &ScreenSessionManagerStub::SuspendBeginFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SUSPEND_END,
        &ScreenSessionManagerStub::SuspendEndFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SET_DISPLAY_STATE,
        &ScreenSessionManagerStub::SetDisplayStateFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_GET_DISPLAY_STATE,
        &ScreenSessionManagerStub::GetDisplayStateFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_NOTIFY_DISPLAY_EVENT,
        &ScreenSessionManagerStub::NotifyDisplayEventFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_SCREEN_POWER,
        &ScreenSessionManagerStub::GetScreenPowerFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_DISPLAY_BY_ID,
        &ScreenSessionManagerStub::GetDisplayByIdFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_DISPLAY_BY_SCREEN,
        &ScreenSessionManagerStub::GetDisplayByScreenFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_ALL_DISPLAYIDS,
        &ScreenSessionManagerStub::GetAllDisplayidsFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_SCREEN_INFO_BY_ID,
        &ScreenSessionManagerStub::GetScreenInfoByIdFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_ALL_SCREEN_INFOS,
        &ScreenSessionManagerStub::GetAllScreenInfosFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_DESTROY_VIRTUAL_SCREEN,
        &ScreenSessionManagerStub::DestroyVirtualScreenFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_MAKE_MIRROR,
        &ScreenSessionManagerStub::ScreenMakeMirrorFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_STOP_MIRROR,
        &ScreenSessionManagerStub::ScreenStopMirrorFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_DISABLE_MIRROR,
        &ScreenSessionManagerStub::ScreenDisableMirrorFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_MAKE_EXPAND,
        &ScreenSessionManagerStub::ScreenMakeExpandFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_STOP_EXPAND,
        &ScreenSessionManagerStub::ScreenStopExpandFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_GET_DISPLAY_SNAPSHOT,
        &ScreenSessionManagerStub::GetDisplaySnapshotFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_SNAPSHOT_BY_PICKER,
        &ScreenSessionManagerStub::GetSnapshotByPickerFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SET_SCREEN_ACTIVE_MODE,
        &ScreenSessionManagerStub::SetScreenActiveModeFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_SET_RESOLUTION,
        &ScreenSessionManagerStub::SetResolutionFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_GET_COLOR_GAMUT,
        &ScreenSessionManagerStub::ScreenGetColorGamutFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_SET_COLOR_GAMUT,
        &ScreenSessionManagerStub::ScreenSetColorGamutFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_GET_GAMUT_MAP,
        &ScreenSessionManagerStub::ScreenGetGamutMapFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_GET_HDR_FORMAT,
        &ScreenSessionManagerStub::ScreenGetHdrFormatFunc);
}
...
void ScreenSessionManagerStub::InitGroup2() 
{
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_GET_COLOR_SPACE,
        &ScreenSessionManagerStub::ScreenGetColorSpaceFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SCREEN_SET_COLOR_SPACE,
        &ScreenSessionManagerStub::ScreenSetColorSpaceFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_SET_ORIENTATION,
        &ScreenSessionManagerStub::SetOrientationFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_GET_CUTOUT_INFO,
        &ScreenSessionManagerStub::GetCutoutInfoFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_HAS_PRIVATE_WINDOW,
        &ScreenSessionManagerStub::HasPrivateWindowFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_HAS_IMMERSIVE_WINDOW,
        &ScreenSessionManagerStub::HasImmersiveWindowFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_DEVICE_IS_CAPTURE,
        &ScreenSessionManagerStub::DeviceIsCaptureFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_SET_CLIENT,
        &ScreenSessionManagerStub::SetClientFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_SCREEN_PROPERTY,
        &ScreenSessionManagerStub::GetScreenPropertyFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_DISPLAY_NODE,
        &ScreenSessionManagerStub::GetDisplayNodeFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_RESIZE_VIRTUAL_SCREEN,
        &ScreenSessionManagerStub::ResizeVirtualScreenFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_UPDATE_AVAILABLE_AREA,
        &ScreenSessionManagerStub::UpdateAvailableAreaFunc);
    BindOp(DisplayManagerMessage::TRANS_ID_GET_AVAILABLE_AREA,
        &ScreenSessionManagerStub::GetAvailableAreaFunc);
    ...
    BindOp(DisplayManagerMessage::TRANS_ID_SWITCH_USER,
        &ScreenSessionManagerStub::SwitchUserFunc);
}
...
int32_t ScreenSessionManagerStub::GetDefaultDisplayInfoFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::RegisterDisplayManagerAgentFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::UnregisterDisplayManagerAgentFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    auto agent = iface_cast<IDisplayManagerAgent>(data.ReadRemoteObject());
    if (agent == nullptr) {
        return ERR_INVALID_DATA;
...
int32_t ScreenSessionManagerStub::WakeUpBeginFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::WakeUpEndFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    reply.WriteBool(WakeUpEnd());
    return 0;
}

int32_t ScreenSessionManagerStub::SuspendBeginFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    PowerStateChangeReason reason = static_cast<PowerStateChangeReason>(data.ReadUint32());
...
int32_t ScreenSessionManagerStub::SuspendEndFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    reply.WriteBool(SuspendEnd());
    return 0;
}

int32_t ScreenSessionManagerStub::SetDisplayStateFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SetSpecificScreenPowerFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SetScreenPowerForAllFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenPowerState state = static_cast<ScreenPowerState>(data.ReadUint32());
    PowerStateChangeReason reason = static_cast<PowerStateChangeReason>(data.ReadUint32());
...
int32_t ScreenSessionManagerStub::GetDisplayStateFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::NotifyDisplayEventFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetScreenPowerFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetDisplayByIdFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetDisplayByScreenFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetAllDisplayidsFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetScreenInfoByIdFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::GetAllScreenInfosFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::ScreenGetSupportedColorGamutsFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::CreateVirtualScreenFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SetVirtualScreenSurfaceFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
    bool isSurfaceValid = data.ReadBool();
...
int32_t ScreenSessionManagerStub::SetVirtualScreenCanvasRotationFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
    bool isSurfaceValid = data.ReadBool();
    sptr<IBufferProducer> bp = nullptr;
...
int32_t ScreenSessionManagerStub::SetVirtualScreenScaleModeFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::DestroyVirtualScreenFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenMakeMirrorFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::ScreenStopMirrorFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::ScreenDisableMirrorFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::ScreenMakeExpandFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::ScreenStopExpandFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetScreenGroupInfoByIdFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::RemoveVirtualScreenFromScreenGroupFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    std::vector<ScreenId> screenId;
    if (!data.ReadUInt64Vector(&screenId)) {
...
int32_t ScreenSessionManagerStub::GetDisplaySnapshotFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    DisplayId displayId = data.ReadUint64();
...
int32_t ScreenSessionManagerStub::GetSnapshotByPickerFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ProcGetSnapshotByPicker(reply);
    return 0;
}

int32_t ScreenSessionManagerStub::SetScreenActiveModeFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::SetVirtualPixelRatioFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::SetVirtualPixelRatioSystemFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
    float virtualPixelRatio = data.ReadFloat();
...
int32_t ScreenSessionManagerStub::SetResolutionFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
    uint32_t width = data.ReadUint32();
    uint32_t height = data.ReadUint32();
...
int32_t ScreenSessionManagerStub::GetDensityInCurrentResolutionFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenGetColorGamutFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenSetColorGamutFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenGetGamutMapFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenSetGamutMapFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenSetColorTransformFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenGetPixelFormatFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenSetPixelFormatFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenGetSupportedHdrFormatFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenGetHdrFormatFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenSetHdrFormatFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenGetSupportedColorSpaceFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenGetColorSpaceFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ScreenSetColorSpaceFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::SetOrientationFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::SetScreenRotationtionLockedFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::IsScreenRotationLockedFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    bool isLocked = false;
...
int32_t ScreenSessionManagerStub::GetCutoutInfoFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    DisplayId displayId = static_cast<DisplayId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::HasPrivateWindowFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::ConvertScreenidToRsscreenidFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::HasImmersiveWindowFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SceneBoardDumpAllScreenFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    std::string dumpInfo;
...
int32_t ScreenSessionManagerStub::SceneBoardDumpSpecialScreenFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
    std::string dumpInfo;
...
int32_t ScreenSessionManagerStub::DeviceIsCaptureFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    reply.WriteBool(IsCaptured());
    return 0;
}

int32_t ScreenSessionManagerStub::SceneBoardSetFoldDisplayModeFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SceneBoardLockFoldDisplayStatusFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SceneBoardGetFoldDisplayModeFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SceneBoardIsFoldableFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    reply.WriteBool(IsFoldable());
    return 0;
}

int32_t ScreenSessionManagerStub::SceneBoardGetFoldStatusFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    reply.WriteUint32(static_cast<uint32_t>(GetFoldStatus()));
    return 0;
}

int32_t ScreenSessionManagerStub::SceneBoardGetCurrentFoldCreaseRegionFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    reply.WriteStrongParcelable(GetCurrentFoldCreaseRegion());
    return 0;
}

int32_t ScreenSessionManagerStub::SceneBoardMakeUniqueScreenFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SetClientFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetScreenPropertyFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetDisplayNodeFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    auto screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::UpdateScreenRotationPropertyFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    auto screenId = static_cast<ScreenId>(data.ReadUint64());
    RRect bounds;
...
int32_t ScreenSessionManagerStub::GetCurvedScreenCompressionAreaFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetPhyScreenPropertyFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    auto screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::NotifyDisplayChangeInfoFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SetScreenPrivacyStateFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SetScreenidPrivacyStateFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    DisplayId displayId = static_cast<DisplayId>(data.ReadUint64());
    auto hasPrivate = data.ReadBool();
...
int32_t ScreenSessionManagerStub::SetScreenPrivacyWindowListFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    DisplayId displayId = static_cast<DisplayId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::ResizeVirtualScreenFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
    uint32_t width = data.ReadUint32();
    uint32_t height = data.ReadUint32();
...
int32_t ScreenSessionManagerStub::UpdateAvailableAreaFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    auto screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::GetAvailableAreaFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ProcGetAvailableArea(data, reply);
    return 0;
}

int32_t ScreenSessionManagerStub::NotifyFoldToExpandCompletionFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::GetVirtualScreenFlagFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ProcGetVirtualScreenFlag(data, reply);
    return 0;
}

int32_t ScreenSessionManagerStub::SetVirtualScreenFlagFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ProcSetVirtualScreenFlag(data, reply);
    return 0;
}

int32_t ScreenSessionManagerStub::GetDeviceScreenConfigFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
...
int32_t ScreenSessionManagerStub::SetVirtualScreenRefreshRateFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
...
int32_t ScreenSessionManagerStub::SwitchUserFunc(MessageParcel& data, MessageParcel& reply, MessageOption &option)
{
    SwitchUser();
    return 0;
}
