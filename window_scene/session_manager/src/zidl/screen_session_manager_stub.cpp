...
int32_t ScreenSessionManagerStub::ProcScreenGetSupportedHDRFormats(MessageParcel& data, MessageParcel& reply)
{
    ScreenId screenId = static_cast<ScreenId>(data.ReadUint64());
