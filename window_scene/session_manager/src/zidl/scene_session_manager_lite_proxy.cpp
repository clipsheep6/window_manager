...
{
    WLOGFI("run SceneSessionManagerLiteProxy::SetSessionLabel");
    MessageParcel data;
    MessageParcel reply;
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::SetSessionIcon");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::IsValidSessionIds");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::PendingSessionToForeground");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::PendingSessionToBackgroundForDelegator");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::RegisterSessionListener");
    MessageParcel data;
    MessageParcel reply;
    ...
    if (Remote()->SendRequest(static_cast<uint32_t>(SceneSessionManagerLiteMessage::TRANS_ID_REGISTER_SESSION_LISTENER),
        data, reply, option) != ERR_NONE) {
        WLOGFE("SendRequest failed");
        return WSError::WS_ERROR_IPC_FAILED;
    }
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::UnRegisterSessionListener");
    if (listener == nullptr) {
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::GetSessionInfos");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option(MessageOption::TF_SYNC);
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::GetSessionInfo");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option(MessageOption::TF_SYNC);
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::LockSession");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::UnlockSession");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::MoveSessionsToForeground");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    if (!data.WriteInterfaceToken(GetDescriptor())) {
    ...
    if (Remote()->SendRequest(static_cast<uint32_t>(SceneSessionManagerLiteMessage::TRANS_ID_MOVE_MISSIONS_TO_FOREGROUND),
        data, reply, option) != ERR_NONE) {
        WLOGFE("SendRequest failed");
        return WSError::WS_ERROR_IPC_FAILED;
    }
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::MoveSessionsToBackground");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    if (!data.WriteInterfaceToken(GetDescriptor())) {
    ...
    if (Remote()->SendRequest(static_cast<uint32_t>(SceneSessionManagerLiteMessage::TRANS_ID_MOVE_MISSIONS_TO_BACKGROUND),
        data, reply, option) != ERR_NONE) {
        WLOGFE("SendRequest failed");
        return WSError::WS_ERROR_IPC_FAILED;
    }
...
{
    WLOGFI("run SceneSessionManagerLiteProxy::ClearSession");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    if (!data.WriteInterfaceToken(GetDescriptor())) {
