    ...
    MessageParcel &data, MessageParcel &reply, MessageOption &option)
{
    ...
    switch (code) {
        case SceneSessionManagerLiteMessage::TRANS_ID_SET_SESSION_LABEL:
            return HandleSetSessionLabel(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_SET_SESSION_ICON:
            return HandleSetSessionIcon(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_IS_VALID_SESSION_IDS:
            return HandleIsValidSessionIds(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_PENDING_SESSION_TO_FOREGROUND:
        ...
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_FOCUS_SESSION_TOKEN:
            return HandleGetFocusSessionToken(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_FOCUS_SESSION_ELEMENT:
            return HandleGetFocusSessionElement(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_REGISTER_SESSION_LISTENER:
            return HandleRegisterSessionListener(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_UNREGISTER_SESSION_LISTENER:
            return HandleUnRegisterSessionListener(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_MISSION_INFOS:
            return HandleGetSessionInfos(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_MISSION_INFO_BY_ID:
            return HandleGetSessionInfo(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_SESSION_INFO_BY_CONTINUE_SESSION_ID:
            return HandleGetSessionInfoByContinueSessionId(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_TERMINATE_SESSION_NEW:
            return HandleTerminateSessionNew(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_SESSION_SNAPSHOT:
            return HandleGetSessionSnapshot(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_SET_SESSION_CONTINUE_STATE:
            return HandleSetSessionContinueState(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_CLEAR_SESSION:
            return HandleClearSession(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_CLEAR_ALL_SESSIONS:
            return HandleClearAllSessions(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_LOCK_SESSION:
            return HandleLockSession(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_UNLOCK_SESSION:
            return HandleUnlockSession(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_MOVE_MISSIONS_TO_FOREGROUND:
            return HandleMoveSessionsToForeground(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_MOVE_MISSIONS_TO_BACKGROUND:
            return HandleMoveSessionsToBackground(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_FOCUS_SESSION_INFO:
            return HandleGetFocusSessionInfo(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_REGISTER_WINDOW_MANAGER_AGENT:
            return HandleRegisterWindowManagerAgent(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_UNREGISTER_WINDOW_MANAGER_AGENT:
            return HandleUnregisterWindowManagerAgent(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_CHECK_WINDOW_ID:
            return HandleCheckWindowId(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_VISIBILITY_WINDOW_INFO_ID:
            return HandleGetVisibilityWindowInfo(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_WINDOW_MODE_TYPE:
            return HandleGetWindowModeType(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_RAISE_WINDOW_TO_TOP:
            return HandleRaiseWindowToTop(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_TOPN_MAIN_WINDOW_INFO:
            return HandleGetMainWinodowInfo(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_REGISTER_COLLABORATOR:
            return HandleRegisterCollaborator(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_UNREGISTER_COLLABORATOR:
            return HandleUnregisterCollaborator(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_GET_ALL_MAIN_WINDOW_INFO:
            return HandleGetAllMainWindowInfos(data, reply);
        case SceneSessionManagerLiteMessage::TRANS_ID_CLEAR_MAIN_SESSIONS:
