    ...
    MessageParcel &data, MessageParcel &reply, MessageOption &option)
{
    ...
    switch (code) {
        ...
        case SceneSessionManagerMessage::TRANS_ID_RECOVER_AND_CONNECT_SPECIFIC_SESSION:
            return HandleRecoverAndConnectSpecificSession(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_RECOVER_AND_RECONNECT_SCENE_SESSION:
        ...
        case SceneSessionManagerMessage::TRANS_ID_IS_VALID_SESSION_IDS:
            return HandleIsValidSessionIds(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_PENDING_SESSION_TO_FOREGROUND:
            return HandlePendingSessionToForeground(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_PENDING_SESSION_TO_BACKGROUND_FOR_DELEGATOR:
            return HandlePendingSessionToBackgroundForDelegator(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_FOCUS_SESSION_TOKEN:
            return HandleGetFocusSessionToken(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_FOCUS_SESSION_ELEMENT:
            return HandleGetFocusSessionElement(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_CHECK_WINDOW_ID:
        ...
        case SceneSessionManagerMessage::TRANS_ID_GET_UNRELIABLE_WINDOW_INFO:
        ...
        case SceneSessionManagerMessage::TRANS_ID_GET_MISSION_INFOS:
            return HandleGetSessionInfos(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_MISSION_INFO_BY_ID:
            return HandleGetSessionInfo(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_SESSION_INFO_BY_CONTINUE_SESSION_ID:
            return HandleGetSessionInfoByContinueSessionId(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_DUMP_SESSION_ALL:
            return HandleDumpSessionAll(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_DUMP_SESSION_WITH_ID:
            return HandleDumpSessionWithId(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_TERMINATE_SESSION_NEW:
            return HandleTerminateSessionNew(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_UPDATE_AVOIDAREA_LISTENER:
            return HandleUpdateSessionAvoidAreaListener(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_SESSION_DUMP_INFO:
            return HandleGetSessionDump(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_SESSION_SNAPSHOT:
            return HandleGetSessionSnapshot(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_SESSION_SNAPSHOT_BY_ID:
            return HandleGetSessionSnapshotById(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_UI_CONTENT_REMOTE_OBJ:
        ...
        case SceneSessionManagerMessage::TRANS_ID_NOTIFY_DUMP_INFO_RESULT:
            return HandleNotifyDumpInfoResult(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_SET_SESSION_CONTINUE_STATE:
            return HandleSetSessionContinueState(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_CLEAR_SESSION:
            return HandleClearSession(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_CLEAR_ALL_SESSIONS:
            return HandleClearAllSessions(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_LOCK_SESSION:
            return HandleLockSession(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_UNLOCK_SESSION:
            return HandleUnlockSession(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_MOVE_MISSIONS_TO_FOREGROUND:
            return HandleMoveSessionsToForeground(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_MOVE_MISSIONS_TO_BACKGROUND:
            return HandleMoveSessionsToBackground(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_REGISTER_COLLABORATOR:
            return HandleRegisterCollaborator(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_UNREGISTER_COLLABORATOR:
            return HandleUnregisterCollaborator(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_UPDATE_TOUCHOUTSIDE_LISTENER:
            return HandleUpdateSessionTouchOutsideListener(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_RAISE_WINDOW_TO_TOP:
            return HandleRaiseWindowToTop(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_TOP_WINDOW_ID:
            return HandleGetTopWindowId(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_NOTIFY_WINDOW_EXTENSION_VISIBILITY_CHANGE:
            return HandleNotifyWindowExtensionVisibilityChange(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_UPDATE_WINDOW_VISIBILITY_LISTENER:
            return HandleUpdateSessionWindowVisibilityListener(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_SHIFT_APP_WINDOW_FOCUS:
            return HandleShiftAppWindowFocus(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_VISIBILITY_WINDOW_INFO_ID:
            return HandleGetVisibilityWindowInfo(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_ADD_EXTENSION_WINDOW_STAGE_TO_SCB:
            return HandleAddExtensionWindowStageToSCB(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_ADD_OR_REMOVE_SECURE_SESSION:
            return HandleAddOrRemoveSecureSession(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_UPDATE_EXTENSION_WINDOW_FLAGS:
            return HandleUpdateExtWindowFlags(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_HOST_WINDOW_RECT:
            return HandleGetHostWindowRect(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_WINDOW_STATUS:
            return HandleGetCallingWindowWindowStatus(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_WINDOW_RECT:
            return HandleGetCallingWindowRect(data, reply);
        case SceneSessionManagerMessage::TRANS_ID_GET_WINDOW_MODE_TYPE:
