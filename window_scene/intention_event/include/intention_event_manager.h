...
private:
    ...
    bool CheckOnInputEvent(std::shared_ptr<MMI::KeyEvent>& keyEvent, int32_t focusedSessionId) const;
    bool TransferKeyEvent(std::shared_ptr<MMI::KeyEvent>& keyEvent, int32_t focusedSessionId) const;
