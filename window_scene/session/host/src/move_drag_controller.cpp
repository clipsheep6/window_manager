...
void MoveDragController::SetOriginalValue(int32_t pointerId, int32_t pointerPosX, int32_t pointerPosY,
...
void MoveDragController::ClacFirstMoveTargetRect()
{
    ...
    SetOriginalValue(moveTempProperty_.pointerId_, moveTempProperty_.lastDownPointerPosX_,
