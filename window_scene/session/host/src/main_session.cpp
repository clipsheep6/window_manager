    ...
    : SceneSession(info, specificCallback)
{
    ...
    if (specificCallback != nullptr && specificCallback->onWindowMove_ != nullptr) {
        moveDragController_->SetNotifyWindowPidChangeCallback(specificCallback_->onWindowMove_);
    }
    SetMoveDragCallback();
