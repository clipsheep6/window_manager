...
{
    int32_t persistentId = static_cast<int32_t>(GetPersistentId());
...
void Session::GeneratePersistentId(bool isExtension, const SessionInfo& sessionInfo)
{
    ...
    persistentId_ = isExtension ? static_cast<int32_t>(sessionId_.load()) | 0x40000000 : static_cast<int32_t>(sessionId_.load()) & 0x3fffffff;
