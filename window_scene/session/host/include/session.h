...
using NotifyTerminateSessionFunc = std::function<void(const SessionInfo& info, TerminateType terminateType)>;
...
public:
    ...
    WSError TerminateSession(const sptr<AAFwk::SessionInfo> info, TerminateType terminateType);
    WSError Clear();
