...
{
    TLOGI(WmsLogTag::DMS,
        "[DISNODE]Create Session, reason: %{public}d, screenId: %{public}" PRIu64", rsId: %{public}" PRIu64"",
        reason, screenId_, rsId_);
    TLOGI(WmsLogTag::DMS,
        "[DISNODE]Config name: %{public}s, defaultId: %{public}" PRIu64", mirrorNodeId: %{public}" PRIu64"",
...
{
    TLOGI(WmsLogTag::DMS, "[DISNODE]config screenId: %{public}d, isMirrored: %{public}d, mirrorNodeId: %{public}d ",
