...
napi_value JsSceneSessionManager::Init(napi_env env, napi_value exportObj)
{
    ...
    napi_wrap(env, object, jsSceneSessionManager.release(), JsSceneSessionManager::Finalizer, nullptr, nullptr);
    napi_set_named_property(env, object, "SessionState", CreateJsValue(env, CreateJsSessionState(env)));
    napi_set_named_property(env, object, "SessionType", CreateJsValue(env, SessionTypeInit(env)));
    napi_set_named_property(env, object, "SessionSizeChangeReason", CreateJsSessionSizeChangeReason(env));
 

    const char* moduleName = "JsSceneSessionManager";
    BindNativeFunction(env, object, "getRootSceneSession", moduleName, JsSceneSessionManager::GetRootSceneSession);
    BindNativeFunction(env, object, "requestSceneSession", moduleName, JsSceneSessionManager::RequestSceneSession);
    BindNativeFunction(env, object, "updateSceneSessionWant",
        moduleName, JsSceneSessionManager::UpdateSceneSessionWant);
    BindNativeFunction(env, object, "requestSceneSessionActivation", moduleName,
        JsSceneSessionManager::RequestSceneSessionActivation);
    BindNativeFunction(env, object, "requestSceneSessionBackground", moduleName,
        JsSceneSessionManager::RequestSceneSessionBackground);
    BindNativeFunction(env, object, "requestSceneSessionDestruction", moduleName,
        JsSceneSessionManager::RequestSceneSessionDestruction);
    BindNativeFunction(env, object, "on", moduleName, JsSceneSessionManager::RegisterCallback);
    BindNativeFunction(env, object, "getWindowSceneConfig", moduleName,
        JsSceneSessionManager::GetWindowSceneConfig);
    BindNativeFunction(env, object, "processBackEvent", moduleName, JsSceneSessionManager::ProcessBackEvent);
    BindNativeFunction(env, object, "updateFocus", moduleName, JsSceneSessionManager::UpdateFocus);
    BindNativeFunction(env, object, "switchUser", moduleName, JsSceneSessionManager::SwitchUser);
    BindNativeFunction(env, object, "requestSceneSessionByCall", moduleName,
        JsSceneSessionManager::RequestSceneSessionByCall);
    BindNativeFunction(env, object, "startAbilityBySpecified", moduleName,
        JsSceneSessionManager::StartAbilityBySpecified);
    BindNativeFunction(env, object, "getSessionSnapshot", moduleName,
        JsSceneSessionManager::GetSessionSnapshotFilePath);
    BindNativeFunction(env, object, "InitWithRenderServiceAdded", moduleName,
        JsSceneSessionManager::InitWithRenderServiceAdded);
    BindNativeFunction(env, object, "getAllAbilityInfo", moduleName, JsSceneSessionManager::GetAllAbilityInfos);
    BindNativeFunction(env, object, "prepareTerminate", moduleName, JsSceneSessionManager::PrepareTerminate);
    BindNativeFunction(env, object, "perfRequestEx", moduleName, JsSceneSessionManager::PerfRequestEx);
    BindNativeFunction(env, object, "updateWindowMode", moduleName, JsSceneSessionManager::UpdateWindowMode);
    BindNativeFunction(env, object, "getRootSceneUIContext", moduleName,
        JsSceneSessionManager::GetRootSceneUIContext);
    BindNativeFunction(env, object, "sendTouchEvent", moduleName, JsSceneSessionManager::SendTouchEvent);
...
void JsSceneSessionManager::OnCreateSpecificSession(const sptr<SceneSession>& sceneSession)
{
    ...
    auto complete = std::make_unique<NapiAsyncTask::CompleteCallback>(
        [this, weakSession, jsCallBack, env = env_](napi_env environment, NapiAsyncTask& task, int32_t status) {
            ...
            napi_call_function(environment, NapiGetUndefined(environment), jsCallBack->GetNapiValue(), ArraySize(argv), argv, &callResult);
        });

    NativeReference* callback = nullptr;
    std::unique_ptr<NapiAsyncTask::ExecuteCallback> execute = nullptr;
    NapiAsyncTask::Schedule("JsSceneSessionManager::OnCreateSpecificSession", env_,
...
void JsSceneSessionManager::OnStatusBarEnabledUpdate(bool enable)
{
    ...
    auto jsCallBack = iter->second;
    auto complete = std::make_unique<NapiAsyncTask::CompleteCallback>(
        [this, enable, jsCallBack, env = &env_](napi_env environment, NapiAsyncTask& task, int32_t status) {
    ...
    NativeReference* callback = nullptr;
    std::unique_ptr<NapiAsyncTask::ExecuteCallback> execute = nullptr;
    NapiAsyncTask::Schedule("JsSceneSessionManager::OnStatusBarEnabledUpdate", env_,
        std::make_unique<NapiAsyncTask>(callback, std::move(execute), std::move(complete)));
}
...
void JsSceneSessionManager::OnGestureNavigationEnabledUpdate(bool enable)
{
    ...
    NativeReference* callback = nullptr;
    std::unique_ptr<NapiAsyncTask::ExecuteCallback> execute = nullptr;
    NapiAsyncTask::Schedule("JsSceneSessionManager::OnGestureNavigationEnabledUpdate", env_,
        std::make_unique<NapiAsyncTask>(callback, std::move(execute), std::move(complete)));
}
...
void JsSceneSessionManager::OnOutsideDownEvent(int32_t x, int32_t y)
{
    ...
    auto jsCallBack = iter->second;
    auto complete = std::make_unique<NapiAsyncTask::CompleteCallback>(
        [this, x, y, jsCallBack, env = env_](napi_env environment, NapiAsyncTask& task, int32_t status) {
    ...
    NativeReference* callback = nullptr;
    std::unique_ptr<NapiAsyncTask::ExecuteCallback> execute = nullptr;
    NapiAsyncTask::Schedule("JsSceneSessionManager::OnOutsideDownEvent", env_,
        std::make_unique<NapiAsyncTask>(callback, std::move(execute), std::move(complete)));
}
...
napi_value JsSceneSessionManager::OnGetAllAbilityInfos(napi_env env, napi_callback_info info)
{
    ...
    AAFwk::Want want;
    bool ret = OHOS::AppExecFwk::UnwrapWant(reinterpret_cast<napi_env>(&env),
        reinterpret_cast<napi_value>(argv[0]), want);
    if (!ret) {
    ...
    auto complete = [obj = this, errCode, infos = abilityInfos]
        ...
        if (*errCode != static_cast<int32_t>(WSErrorCode::WS_OK)) {
            task.RejectWithCustomize(env, CreateJsValue(env, *errCode),
                CreateJsValue(env, "invalid params can not get All AbilityInfos!"));
            return;
        }
    ...
    napi_value callback = (argc == ARGC_TWO) ? nullptr : argv[2];
...
napi_value JsSceneSessionManager::CreateAbilityItemInfo(napi_env env,
const AppExecFwk::AbilityInfo& abilityInfo)
{
    ...
    napi_set_named_property(env, objValue, "launchType", CreateJsValue(env, static_cast<int32_t>(abilityInfo.launchMode)));
    ...
    napi_set_named_property(env, objValue, "orientation", CreateJsValue(env, static_cast<int32_t>(abilityInfo.orientation)));
    ...
    napi_set_named_property(env, objValue, "removeSessionAfterTerminate", CreateJsValue(env, abilityInfo.removeMissionAfterTerminate));
    return objValue;
}
...
napi_value JsSceneSessionManager::OnSwitchUser(napi_env env, napi_callback_info info)
{
    ...
    std::string fileDir;
    if (!ConvertFromJsValue(env, argv[2], fileDir)) {
...
napi_value JsSceneSessionManager::OnRequestSceneSession(napi_env env, napi_callback_info info)
{
    ...
    if (errCode == WSErrorCode::WS_OK) {
        napi_value objValue = argv[0];
        napi_create_object(env, &objValue);
        if (objValue == nullptr) {
            WLOGFE("[NAPI]Failed to convert object to session info");
            errCode = WSErrorCode::WS_ERROR_INVALID_PARAM;
        } else if (!ConvertSessionInfoFromJs(env, objValue, sessionInfo)) {
    ...
    if (argc == ARGC_TWO && GetNapiType(env, argv[1]) != napi_undefined) {
...
napi_value JsSceneSessionManager::OnRequestSceneSessionActivation(napi_env env, napi_callback_info info)
{
    ...
    napi_create_object(env, &jsSceneSessionObj);
    if (jsSceneSessionObj == nullptr) {
...
napi_value JsSceneSessionManager::OnRequestSceneSessionBackground(napi_env env, napi_callback_info info)
{
    ...
    if (argc == ARGC_TWO && GetNapiType(env, argv[1]) == napi_boolean) {
...
napi_value JsSceneSessionManager::OnRequestSceneSessionDestruction(napi_env env, napi_callback_info info)
{
    ...
    if (argc == 2 && GetNapiType(env, argv[1]) == napi_boolean) {
...
void JsSceneSessionManager::SetIsClearSession(napi_env env, napi_value jsSceneSessionObj, sptr<SceneSession>& sceneSession)
{
    ...
    if (GetNapiType(env, jsOperatorType) != NATIVE_UNDEFINED) {
...
napi_value JsSceneSessionManager::OnPerfRequestEx(napi_env env, napi_callback_info info)
{
    ...
    std::string msg = "";
    if (argc == ARGC_THREE) {
        if (!ConvertFromJsValue(env, info.argv[2], msg)) {
...
napi_value JsSceneSessionManager::OnGetRootSceneUIContext(napi_env env, napi_callback_info info)
{
    ...
    napi_value uiContext = uiContent->GetNapiUIContext();
...
napi_value JsSceneSessionManager::OnSendTouchEvent(napi_env env, napi_callback_info info)
{
    ...
    uint32_t zIndex;
    if (!ConvertFromJsValue(env, info.argv[1], zIndex)) {
