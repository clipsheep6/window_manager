...
public:
    ...
    static napi_value IsAbilityControllerStart(napi_env env, napi_callback_info info);
...
private:
    ...
    napi_value OnIsAbilityControllerStart(napi_env env, napi_callback_info info);
