...
public:
    ...
    static napi_value GetDisplayIdBySessionId(napi_env env, napi_callback_info info);
...
private:
    ...
    napi_value OnGetDisplayIdBySessionId(napi_env env, napi_callback_info info);
