...
private:
    ...
    static napi_value SetStartSceneWithRotate(napi_env env, napi_callback_info info);
    ...
    napi_value OnSetStartSceneWithRotate(napi_env env, napi_callback_info info);
