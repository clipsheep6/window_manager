...
private:
    ...
    static napi_value SetBufferAvailableCallbackFlag(napi_env env, napi_callback_info info);
    ...
    napi_value OnSetBufferAvailableCallbackFlag(napi_env env, napi_callback_info info);
