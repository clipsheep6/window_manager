...
private:
    ...
    static NativeValue* SetSystemSceneBGAlpha(NativeEngine* engine, NativeCallbackInfo* info);
    ...
    NativeValue* OnSetSystemSceneBGAlpha(NativeEngine& engine, NativeCallbackInfo& info);
