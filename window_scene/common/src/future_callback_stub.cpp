...
const std::map<uint32_t, FutureCallbackStubFunc> FutureCallbackStub::stubFuncMap_{
    std::make_pair(static_cast<uint32_t>(FutureCallbackMessage::TRANS_ID_UPDATE_SESSION_RECT),
        &FutureCallbackStub::HandleUpdateSessionRect),
};
