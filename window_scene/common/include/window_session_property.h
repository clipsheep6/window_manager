...
public:
    ...
    void SetWindowSoftInputMode(SoftInputMode softInputMode);
    ...
    SoftInputMode GetWindowSoftInputMode() const;
...
private:
    ...
    SoftInputMode softInputMode_ = SoftInputMode::UNSPECIFICED;
