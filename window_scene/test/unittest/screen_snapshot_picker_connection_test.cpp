...
HWTEST_F(ScreenSnapshotPickerConnectionTest, SnapshotPickerConnectExtension, Function | SmallTest | Level1)
{
    ...
    ScreenSnapshotPickerConnection::GetInstance().SetScreenSnapshotBundleName(bundleName);
    ScreenSnapshotPickerConnection::GetInstance().SetScreenSnapshotAbilityName(abilityName);
