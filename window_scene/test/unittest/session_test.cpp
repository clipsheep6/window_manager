...
{
    ASSERT_NE(session_, nullptr);
    ASSERT_EQ(WSError::WS_ERROR_INVALID_SESSION, session_->TerminateSessionTotal(nullptr, TerminateType::CLOSE_AND_KEEP_MULTITASK));
}
...
HWTEST_F(WindowSessionTest, TerminateSessionTotal02, Function | SmallTest | Level2)
{
    ...
    ASSERT_EQ(WSError::WS_ERROR_INVALID_OPERATION, session_->TerminateSessionTotal(abilitySessionInfo, TerminateType::CLOSE_AND_KEEP_MULTITASK));
}
...
HWTEST_F(WindowSessionTest, TerminateSessionTotal03, Function | SmallTest | Level2)
{
    ...
    ASSERT_EQ(WSError::WS_OK, session_->TerminateSessionTotal(abilitySessionInfo, TerminateType::CLOSE_AND_KEEP_MULTITASK));
}
...
HWTEST_F(WindowSessionTest, TransferPointerEvent02, Function | SmallTest | Level2)
{
    ASSERT_NE(session_, nullptr);
    session_->sessionInfo_.isSystem_ = true;
    ASSERT_EQ(WSError::WS_ERROR_NULLPTR, session_->TransferPointerEvent(nullptr));
}
...
HWTEST_F(WindowSessionTest, TransferPointerEvent03, Function | SmallTest | Level2)
{
    ...
    property_->SetWindowType(WindowType::WINDOW_TYPE_APP_MAIN_WINDOW);
 ...
 * @tc.desc: WindowType is WINDOW_TYPE_APP_SUB_WINDOW, parentSession_ && parentSession_->CheckDialogOnForeground() is true
 * @tc.type: FUNC
 */
HWTEST_F(WindowSessionTest, TransferPointerEvent04, Function | SmallTest | Level2)
{
    ...
    dialogSession->state_ = SessionState::STATE_INACTIVE;
    session_->dialogVec_.push_back(dialogSession);
    session_->parentSession_ = new Session(info);
...
HWTEST_F(WindowSessionTest, SetSessionFocusableChangeListener, Function | SmallTest | Level2)
{
    ...
    NotifySessionFocusableChangeFunc func = nullptr;
...
HWTEST_F(WindowSessionTest, SetSessionTouchableChangeListener, Function | SmallTest | Level2)
{
    ...
    NotifySessionTouchableChangeFunc func = nullptr;
 ...
 * @tc.desc: isFocused_ not equal isFocused, IsSessionValid() return true
 * @tc.type: FUNC
 */
HWTEST_F(WindowSessionTest, UpdateFocus03, Function | SmallTest | Level2)
{
    ASSERT_NE(session_, nullptr);
