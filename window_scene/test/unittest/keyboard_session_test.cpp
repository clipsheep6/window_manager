...
HWTEST_F(KeyboardSessionTest, NotifyKeyboardPanelInfoChange, Function | SmallTest | Level1)
{
    ...
    EXPECT_NE(keyboardSession->GetSessionProperty(), nullptr);
    keyboardSession->GetSessionProperty()->SetCallingSessionId(id);
 ...
 * @tc.desc: OpenKeyboardSyncTransaction01
 * @tc.type: FUNC
 */
...
{
    SessionInfo info;
    info.abilityName_ = "UpdateCallingSessionIdAndPosition01";
    info.bundleName_ = "UpdateCallingSessionIdAndPosition01";
