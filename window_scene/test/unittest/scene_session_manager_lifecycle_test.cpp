 ...
 * @tc.type: FUNC
*/
HWTEST_F(SceneSessionManagerLifecycleTest, ProcessSubSessionForeground, Function | SmallTest | Level3)
{
    ssm_->sceneSessionMap_.clear();
 ...
 * @tc.type: FUNC
*/
HWTEST_F(SceneSessionManagerLifecycleTest, RecoverAndConnectSpecificSession, Function | SmallTest | Level3)
{
 ...
 * @tc.type: FUNC
*/
HWTEST_F(SceneSessionManagerLifecycleTest, CreateAndConnectSpecificSession, Function | SmallTest | Level3)
{
    int ret = 0;
    sptr<ISessionStage> sessionStage;
    sptr<IWindowEventChannel> eventChannel;
 ...
 * @tc.type: FUNC
*/
HWTEST_F(SceneSessionManagerLifecycleTest, DestroySpecificSession, Function | SmallTest | Level3)
{
 ...
 * @tc.type: FUNC
*/
HWTEST_F(SceneSessionManagerLifecycleTest, DestroyAndDisconnectSpecificSession, Function | SmallTest | Level3)
{
 ...
 * @tc.type: FUNC
*/
HWTEST_F(SceneSessionManagerLifecycleTest, DestroyAndDisconnectSpecificSessionWithDetachCallback, Function | SmallTest | Level3)
{
    int32_t persistentId = 0;
 ...
 * @tc.type: FUNC
*/
HWTEST_F(SceneSessionManagerLifecycleTest, PreHandleCollaborator, Function | SmallTest | Level3)
{
    SessionInfo info;
