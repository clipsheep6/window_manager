 ...
 * @tc.type: FUNC
 */
HWTEST_F(SceneSessionManagerStubLifecycleTest, HandleCreateAndConnectSpecificSession, Function | SmallTest | Level2)
{
    if (stub_ == nullptr) {
        return;
    }
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SceneSessionManagerStubLifecycleTest, HandleRecoverAndConnectSpecificSession, Function | SmallTest | Level2)
{
    if (stub_ == nullptr) {
        return;
    }
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SceneSessionManagerStubLifecycleTest, HandleDestroyAndDisconnectSpcificSession, Function | SmallTest | Level2)
{
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SceneSessionManagerStubLifecycleTest, HandleDestroyAndDisconnectSpcificSessionWithDetachCallback,
