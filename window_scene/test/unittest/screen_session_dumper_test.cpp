 ...
 * @tc.type: FUNC
 */
HWTEST_F(ScreenRotationPropertyTest, Dump01, Function | SmallTest | Level1)
{
    int fd = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ScreenRotationPropertyTest, Dump02, Function | SmallTest | Level1)
{
    int fd = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ScreenRotationPropertyTest, Dump03, Function | SmallTest | Level1)
{
    int fd = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ScreenRotationPropertyTest, Dump04, Function | SmallTest | Level1)
{
    int fd = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ScreenRotationPropertyTest, Dump05, Function | SmallTest | Level1)
{
    int fd = -1;
    std::vector<std::u16string> args = {u"-h"};
    sptr<ScreenSessionDumper> dumper = new ScreenSessionDumper(fd, args);
