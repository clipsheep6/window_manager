 ...
 * @tc.type: FUNC
 */
HWTEST_F(SessionManagerTestLite, OnWMSConnectionChangedCallback, Function | SmallTest | Level2)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SessionManagerTestLite, RegisterWMSConnectionChangedListener, Function | SmallTest | Level2)
{
  SessionManagerLite sessionManagerLite;
