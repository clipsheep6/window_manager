...
/**
 * @tc.name: SessionStubLifecycleTest01
 * @tc.desc: sessionStub SessionStubLifecycleTest01
 * @tc.type: FUNC
 * @tc.require: #I6JLSI
 */
HWTEST_F(SessionStubLifecycleTest, SessionStubLifecycleTest01, Function | SmallTest | Level2)
{
    MessageParcel data;
    MessageParcel reply;
    data.WriteBool(true);
