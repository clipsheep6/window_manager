...
HWTEST_F(RootSceneSessionTest, SetLoadContentFunc, Function | SmallTest | Level1)
{
    ...
    RootSceneSession rootSceneSession(info);
    ...
    ASSERT_EQ(rootSceneSession.GetSessionInfo().abilityName_, info.abilityName_);
}
...
HWTEST_F(RootSceneSessionTest, LoadContentFunc, Function | SmallTest | Level1)
{
    ...
    ASSERT_EQ(rootSceneSession.GetSessionInfo().bundleName_, info.bundleName_);
}
